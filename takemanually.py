    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\Users\kumar\OneDrive\Desktop\UnauthorizedAccessDetection-UnauthorizedAccessDetection\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'"C:\Users\kumar\OneDrive\Desktop\UnauthorizedAccessDetection-UnauthorizedAccessDetection\Attendance(Manually)"'
                )
